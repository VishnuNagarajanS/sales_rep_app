...
export const INITIAL_CUSTOMERS: Customer[] = [
  ...
  },
  {
    ...
    notes: 'Converted from high-ticket inbound lead. Looking for commercial Grade-A pre-leased assets.',
    customFields: {
      investmentCapacity: '₹1 Cr – ₹3 Cr',
  ...
  },
  {
    id: 'cust-ghl-03',
    companyId: 't-ghl-01',
    name: 'Moorthi Ramanathan',
    phone: '+91 98800 44556',
    email: 'moorthi@chennaienterprises.com',
    status: 'Active',
    assignedAgentId: 'usr-ghl-exec',
    assignedAgentName: 'Ananya Iyer',
    location: 'R.A. Puram, Chennai',
    lastContacted: 'Yesterday, 03:00 PM',
    openDealsCount: 1,
    totalValue: 40000000,
    createdAt: '2026-02-20',
    notes: 'High net-worth private client. Interested in warehousing logistics tranches.',
    customFields: {
      investmentCapacity: '₹3 Cr – ₹5 Cr',
      preferredAssetClass: 'Warehousing Logistics',
    },
  },
  {
    id: 'cust-ghl-04',
    companyId: 't-ghl-01',
    name: 'Mukesh Ambani Group Holdings',
    phone: '+91 99200 88990',
    email: 'mandates@rilholdings.in',
    status: 'VIP',
    assignedAgentId: 'usr-ghl-exec',
    assignedAgentName: 'Ananya Iyer',
    ...
    notes: 'Institutional capital mandate for commercial office assets in prime corridors.',
    customFields: {
      investmentCapacity: '₹25 Cr+',
      preferredAssetClass: 'Commercial Pre-Leased Office',
    },
  },
  {
    id: 'cust-ghl-05',
    ...
    email: 'rajesh.nambiar@meditech.org',
    status: 'VIP',
    assignedAgentId: 'usr-ghl-exec',
    assignedAgentName: 'Ananya Iyer',
    assignedIrmId: 'irm-01',
    assignedIrmName: 'Arun Kumar',
    assignedIrmAt: '2026-02-25',
    location: 'Koramangala, Bengaluru',
    lastContacted: 'Yesterday, 11:15 AM',
    openDealsCount: 1,
    totalValue: 75000000,
    createdAt: '2026-01-28',
    notes: 'Active investor assigned to Arun Kumar for fund allocation.',
    customFields: {
      investmentCapacity: '₹5 Cr – ₹10 Cr',
      preferredAssetClass: 'Fintech Hub Pre-Leased',
    },
  },
  // Jamin Customer
  {
...
export const INITIAL_DEALS: Deal[] = [
  ...
  },
  {
    ...
    assignedAgentName: 'Ananya Iyer',
    phone: '+91 98451 12233',
    email: 'dr.nambiar@manipalhealth.com',
    priority: 'High',
    location: 'Indiranagar, Bengaluru',
  ...
  },
  {
    ...
    email: 'siddharth.singhania@singhaniagroup.in',
    priority: 'High',
    location: 'Koramangala, Bengaluru',
    preferredAssetClass: 'Commercial Pre-Leased',
  ...
  },
  {
    ...
    email: 'aditya@singhalholdings.com',
    priority: 'High',
    location: 'Whitefield, Bengaluru',
...
export const MOCK_IRMS: IrmProfile[] = [
  {
    id: 'irm-01',
    name: 'Arun Kumar',
    experience: '5 Years',
    ...
    performance: 92,
    status: 'Available',
    email: 'arun.kumar@ghlindiatrust.com',
  ...
  },
  {
    ...
    performance: 95,
    status: 'Available',
    email: 'ananya.iyer@ghlindiatrust.com',
    phone: '+91 97420 55667',
  },
  {
    id: 'irm-03',
    ...
    performance: 89,
    status: 'Busy',
    email: 'rohan.mehta@ghlindiatrust.com',
    phone: '+91 98110 77889',
  },
  {
    id: 'irm-04',
  ...
  },
  {
    ...
    performance: 88,
    status: 'Available',
    email: 'karthik.s@ghlindiatrust.com',
    phone: '+91 99001 88776',
  },
];

export const INITIAL_DEAL_ACTIVITIES: DealActivity[] = [
  {
    id: 'act-01',
    dealId: 'deal-ghl-03',
    companyId: 't-ghl-01',
    type: 'note',
    text: 'Sales handover complete. Client requested detailed tenant covenant and lease lock-in details.',
    loggedByName: 'Ananya Iyer',
    loggedByRole: 'IRM',
  ...
  },
  {
    ...
    companyId: 't-ghl-01',
    type: 'stage_change',
    text: 'Sales Handover → Leads',
    fromStage: 'sales_handover',
    toStage: 'leads',
    loggedByName: 'Ananya Iyer',
    loggedByRole: 'IRM',
  ...
  },
  {
    ...
    companyId: 't-ghl-01',
    type: 'whatsapp',
    text: 'Sent summary teaser for Fintech Hub Grade-A Pre-Leased via WhatsApp.',
    loggedByName: 'Ananya Iyer',
    loggedByRole: 'IRM',
  ...
  },
  {
    ...
    companyId: 't-ghl-01',
    type: 'call',
    text: 'Call connected: Discussed legal terms and 12-year lock-in structure with Dr. Rajesh Nambiar.',
    loggedByName: 'Ananya Iyer',
    loggedByRole: 'IRM',
  ...
  },
  {
    ...
    companyId: 't-ghl-01',
    type: 'meeting',
    text: 'Term sheet review meeting held with family office legal counsel. Escrow structure approved.',
    loggedByName: 'Vikram Malhotra',
    loggedByRole: 'IRM',
